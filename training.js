...
let dialogState = 0;
let dialogs = [
  "Yay! Today I'll walk you through how to make a matcha that you can take to go. (click to continue)", 
  ...
  "Congrats! You made your first matcha! You've got some natural skills. I guess I'll be seeing you more often. Click the matcha sign to go drink you matcha."
];
let showDialog = true;
